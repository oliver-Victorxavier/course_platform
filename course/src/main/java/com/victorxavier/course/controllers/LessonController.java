...
import com.victorxavier.course.dto.LessonDTO;
import com.victorxavier.course.models.LessonModel;
import com.victorxavier.course.models.ModuleModel;
import com.victorxavier.course.services.LessonService;
import com.victorxavier.course.services.ModuleService;
...
public class LessonController {
    ...
    public ResponseEntity<Page<LessonModel>> getAllLessons(@PathVariable(value = "moduleId") UUID moduleId,
        ...
        return ResponseEntity.status(HttpStatus.OK).body(lessonService.findAllByModule(SpecificationTemplate.lessonModeleId(moduleId).and(spec), pageable));
    }
